...
var back2 =  makeShape(d,n,a,f1,f2,bAndDSize,radians(addToStart),radians(240),radians(addToCandD));
var back1 =  makeShape(d,n,a,f1,f2,bAndDSize,radians(addToStart),radians(120),radians(addToCandD));
var back3 =  makeShape(d,n,a,f1,f2,bAndDSize,radians(addToStart),radians(360),radians(addToCandD));

var finish = back2 + '\n' + back1 + '\n' + back3 + '\n' + extra;
//var finish = back2 + '\n' + back3 + '\n' + back3 + \'n' + extra + '\n';
//var finish = back1 + extra
//var finish = back + extra;
console.log(finish);
//console.log(back3);
